-- 1. auto_increment 란?(자동 번호 생성 - 오라클 : 시퀀스)
...
ALTER TABLE 테이블명 AUTO_INCREMENT= n; : n번째 부터 PK가 붙는다.
TRUNCATE TABLE 테이블명;
DELETE FROM 테이블명 where 테이블 = pk번호; - 단순 자료 만 삭제 초기화 기능은 없다.
